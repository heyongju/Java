...
public class proJ {
	...
	static class MyFrame extends JFrame{
		...
		static int ballSpeed = 2; //공이 1타이머당 2픽셀씩
		...
		static int barLeftYTarget = barLeftPos.y; //왼쪽 바 목표값
		static int barRightYTarget = barRightPos.y; //오른쪽 바 목표값 부드럽게 이동하기위해서 
		...
		public void startTimer() {
			timer = new Timer(10, new ActionListener() { //화면 딜레이 값과 액션리스너 생성
